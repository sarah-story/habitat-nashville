    ...
    $.get("https://www.eventbriteapi.com/v3/users/me/owned_events/?token=UYNH2POKDBXS4RMSDZJV&expand=ticket_classes,venue", function( data ) {
        ...
        $.each(events, function(i, event) {
            ...
            if (remaining_tickets > 0) {
                html += "<div class='well'><h2>" + event.name.html + "</h2><p>" + event.venue.address.address_1 + "</p><p>Remaining spots: <b>" + remaining_tickets + "</b></p><a class='btn btn-default' href='" + event.url + "' role='button' target='_blank'>Sign Up to Volunteer</a></div>";
            }
        });
        $("#upcoming").html(html);
    });
